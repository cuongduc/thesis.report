...
In addition, this test can be considered as a real test case for a alarm application on Android phone that the tester have to conduct before releasing the application to the market.
