...
Typing Test is more and more complicated. It requires the most accuracy in the movements of the robot. The current setting of the Delta robot is not the best. Any small shift of the robot pillars can cause the deviation of the stylus. The result is not very good due to the instability of the robot's frame. On the other hand, the screen size has to be large enough for the stylus to click on the correct keys. The limitation of stylus size and screen size can contribute a small deviation of the result.
