...
The operation is performed with high precision with delta robots. Along with that, the content of the device's screen is processed on computer with image content detection technology.
All actions are controlled under testing script handling systems. With this approach, we can solve both software and hardware aspect of mobile phone testing problems.
...
In this thesis, I conduct several test scenarios to test the accuracy of the robot as well as the testing script handling system. Each script is run repeatedly, thereby produces results and accuracy statistics of the script. With the results, we hope that our approach can be applied extensively in device and software testing industry.
